...
const FormEsercente = ({match, location, ...props}) => {
    ...
    const handleSubmit = e => {
        e.preventDefault();
        setApi({status: "submit", data: api.data})
    }
                        ...
                        <Card.Body>
                            <Form.Group tag="fieldset" className="mx-lg-3 mx-xl-5">
                                ...
                                <Form.Group as={Row} controlId="email">
                                    ...
                                    <Col sm="10" lg="4">
                                        <Form.Control required isInvalid={isInvalid(errors, "email")} name="email"
                                ...
                                <Form.Group as={Row} controlId="username">
                                    ...
                                    <Col sm="10" lg="4">
                                        <Form.Control required isInvalid={isInvalid(errors, "username")} name="username"
                        ...
                        <Card.Body>
                            <Form.Group tag="fieldset" className="mx-lg-3 mx-xl-5">
                                ...
                                <Form.Group as={Row} controlId="nome">
                                    ...
                                    <Col sm="10" lg="4">
                                        <Form.Control required isInvalid={isInvalid(errors, "nome")} value={nome}
                                        ...
                                        <Form.Group as={Row}>
                                            <Col className="mb-2" sm="8">
                                                <Form.Control placeholder="Via"
                                                              isInvalid={isInvalid(errors, "indirizzo.via")} name="via"
                                                              value={indirizzoVia}
                                                              onChange={e => setIndirizzoVia(e.target.value)}/>
                                                {showErrorsFeedback(errors, "indirizzo.via")}
                                            </Col>
                                            <Col className="mb-2" sm="2">
                                                <Form.Control isInvalid={isInvalid(errors, "indirizzo.civico")}
                                                              id="civico" name="civico" placeholder="Civico"
                                                              value={indirizzoCivico}
                                                              onChange={e => setIndirizzoCivico(e.target.value)}/>
                                                {showErrorsFeedback(errors, "indirizzo.civico")}
                                            </Col>
                                            <Col className="mb-2" sm="3">
                                                <Form.Control size="5" maxLength="5"
                                                              isInvalid={isInvalid(errors, "indirizzo.cap")}
                                                              placeholder="CAP" value={indirizzoCAP}
                                                              onChange={e => setIndirizzoCAP(e.target.value)}/>
                                                {showErrorsFeedback(errors, "indirizzo.cap")}
                                            </Col>
                                            <Col className="mb-2" sm="4">
                                                <Form.Control isInvalid={isInvalid(errors, "indirizzo.citta")}
                                                              id="citta" name="citta" placeholder="citta"
                                                              value={indirizzocitta}
                                                              onChange={e => setIndirizzocitta(e.target.value)}/>
                                                {showErrorsFeedback(errors, "indirizzo.citta")}
                                            </Col>
                                            <Col className="mb-2" sm="3">
                                                <Form.Control size="2" maxLength="2"
                                                              isInvalid={isInvalid(errors, "indirizzo.provincia")}
                                                              id="provincia" name="provincia" placeholder="provincia"
                                                              value={indirizzoProvincia}
                                                              onChange={e => setIndirizzoProvincia(e.target.value)}/>
                        ...
                        <Card.Body>
                            <Form.Group tag="fieldset" className="mx-lg-3 mx-xl-5">
                                ...
                                <Form.Group as={Row} controlId="ragionesociale">
                                    ...
                                    <Col sm="10">
                                        <Form.Control required isInvalid={isInvalid(errors, "ragione_sociale")}
                                ...
                                <Form.Group as={Row}>
                                    ...
                                    <Col>
                                        <Form.Group as={Row}>
                                            <Col className="mb-2" sm="8">
                                                <Form.Control placeholder="Via"
                                                              isInvalid={isInvalid(errors, "sede_legale.via")}
                                                              name="via" value={sedeLegaleVia}
                                                              onChange={e => setSedeLegaleVia(e.target.value)}/>
                                                {showErrorsFeedback(errors, "sede_legale.via")}
                                            </Col>
                                            <Col className="mb-2" sm="2">
                                                <Form.Control isInvalid={isInvalid(errors, "sede_legale.civico")}
                                                              id="civico" name="civico" placeholder="Civico"
                                            ...
                                            <Col className="mb-2" sm="3">
                                                <Form.Control size="5" maxLength="5"
                                                              isInvalid={isInvalid(errors, "sede_legale.cap")}
                                                              placeholder="CAP" value={sedeLegaleCAP}
                                                              onChange={e => setSedeLegaleCAP(e.target.value)}/>
                                                {showErrorsFeedback(errors, "sede_legale.cap")}
                                            </Col>
                                            <Col className="mb-2" sm="4">
                                                <Form.Control isInvalid={isInvalid(errors, "sede_legale.citta")}
                                                              id="citta" name="citta" placeholder="citta"
                                            ...
                                            <Col className="mb-2" sm="3">
                                                <Form.Control size="2" maxLength="2"
                                                              isInvalid={isInvalid(errors, "sede_legale.provincia")}
                                                              id="provincia" name="provincia" placeholder="provincia"
                                                              value={sedeLegaleProvincia}
                                                              onChange={e => setSedeLegaleProvincia(e.target.value)}/>
                                ...
                                <Form.Row>
                                    <Col sm="6">
                                        <Form.Group as={Row} controlId="piva">
                                            ...
                                            <Col sm="8">
                                                <Form.Control size="11" maxLength="11" required
                                                              isInvalid={isInvalid(errors, "piva")} value={piva}
                                    ...
                                    <Col sm="6">
                                        <Form.Group as={Row} controlId="cf">
                                            ...
                                            <Col sm="8">
                                                <Form.Control size="16" maxLength="16" required
                                                              isInvalid={isInvalid(errors, "cf")} value={cf}
                                ...
                                <Form.Row>
                                    <Col sm="6">
                                        <Form.Group as={Row} controlId="pec">
                                            ...
                                            <Col sm="8">
                                                <Form.Control isInvalid={isInvalid(errors, "pec")} type="email"
                                    ...
                                    <Col sm="6">
                                        <Form.Group as={Row} controlId="SDI">
                                            ...
                                            <Col sm="8">
                                                <Form.Control isInvalid={isInvalid(errors, "sdi")} type="text"
                                                              maxLength="7" value={sdi}

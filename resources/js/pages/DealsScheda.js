...
const DealsScheda = ({ varianti, location, history, ...props }) => {
    ...
    if (varianti && deal && deal.tariffe) {
        Object.keys(deal.tariffe).map(variante => {
            ...
            <Col xs="12" md="6">
                <Card>
                    <Card.Body>
                        ...
                        <EditableField as="textarea" rows="4" name="descrizione" label="Descrizione" initialValue={descrizione} {...editableFieldProps} />

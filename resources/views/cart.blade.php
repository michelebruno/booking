            ...
            @guest
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control" name="name" id="name" aria-describedby="helpName" placeholder="Il tuo nome" required>
                    ...
                    <div class="form-group">
                      ...
                      <input type="checkbox"
                        class="form-control" name="GDPR" id="GDPR" required >
                    </div>
            ...
            <form action="{{ route('cart.store') }}" method="post">
                ...
                <select name="prodotto" >
                    @foreach (App\Deal::all() as $deal)
                        <option value="{{ $deal->codice }}">{{ $deal->titolo }}</option>
                    @endforeach
                </select>
                <select name="tariffa">
